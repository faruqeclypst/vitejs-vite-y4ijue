        ...
        <table className="min-w-full table-fixed">
          <thead>
            <tr className="bg-gray-100">
              <th className="px-4 py-2 text-left w-2/5">Nama</th>
              <th className="px-4 py-2 text-left w-2/5">Kode</th>
              <th className="px-4 py-2 text-right w-1/5">Aksi</th>
            </tr>
          </thead>
          <tbody>
            {filteredAndSortedTeachers.map((teacher) => (
              <tr key={teacher.id} className="border-b">
                <td className="px-4 py-2 truncate">{teacher.name}</td>
                <td className="px-4 py-2 truncate">{teacher.code}</td>
