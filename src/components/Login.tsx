...
const Login: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-gradient-to-br from-blue-500 to-purple-600 overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-br from-blue-500 to-blue-600"></div>
      <div className="max-w-md w-full mx-4 bg-white rounded-xl shadow-2xl p-8 space-y-8 relative z-10">
        {/* Logo/Icon */}
